...
def home_page(request: Request):
    ...
    image_url_3 = request.url_for("static", path=f"/static/website_flow.png")
    image_url_4 = request.url_for("static", path=f"/static/telugu_dictionary_flowchart.png")
    image_url_5 = request.url_for("static", path=f"imgs/website_flow.png")
    image_url_6 = request.url_for("static", path=f"imgs/telugu_dictionary_flowchart.png")
    image_url_7 = request.url_for("static", path=f"/static/imgs/website_flow.png")
    image_url_8 = request.url_for("static", path=f"/static/imgs/telugu_dictionary_flowchart.png")
    return templates.TemplateResponse("home.html", {"request": request, "visits": visits, "image_1": image_url_1, "image_2": image_url_2, "image_3": image_url_3, "image_4": image_url_4, "image_5": image_url_5, "image_6": image_url_6, "image_7": image_url_7, "image_8": image_url_8})
